...
class SidesControllerTest < ActionController::TestCase
  ...
  test "should create side" do
    assert_difference('Side.count') do
      post :create, side: { description: @side.description, name: @side.name, price: @side.price, spicy: @side.spicy }
    end
  ...
  test "should update side" do
    patch :update, id: @side, side: { description: @side.description, name: @side.name, price: @side.price, spicy: @side.spicy }
    assert_redirected_to side_path(assigns(:side))
  end
